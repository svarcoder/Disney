...
The first step to running Disney Clone locally is downloading the code by cloning the repository:

```sh
git clone https://github.com/svarcoder/Disney.git
```
